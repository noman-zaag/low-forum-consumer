    ...
    <div className="">
      ...
      <div className="relative h-[307px] w-full flex items-center justify-start px- lg:px-16">
        ...
        <div
          ...
          style={{
            backgroundImage: `url(${"/assets/images/contact_us_image.svg"})`, // Replace with the actual path to your background image
          }}
        ></div>
        <Container className={"flex flex-col items-start justify-center"}>
          ...
          <div className="relative z-10 text-white">
            ...
            <h1 className="text-4xl lg:text-[58px] font-bold  mb-4">Contact Us</h1>
          </div>
        </Container>
      </div>
